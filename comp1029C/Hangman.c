...
int main()
{
    ...
    //    of 0 to (number of words) - 1#include <stdbool.h>
    //
    secretwordindex = rand() % sizeof(words)/20;
    ...
    //
    while (strlen(wrongs)<6 && iswordcomplete(words[secretwordindex],rights)==false) {
        ...
        //
        // for(int i; i < strlen(words[secretwordindex]); i++){
    ...
    //
    if (iswordcomplete(words[secretwordindex],rights)==true) {
        printf("You have won!\n");
    }
    else {
