...
void test_insert() {
    ...
    insert(deque, begin(deque), 75);
    cout << "The deque now is: ";
    print_deque(deque);

    insert(deque, prev(end(deque)), 85);
    cout << "The deque now is: ";
    print_deque(deque);

    insert(deque, prev(end(deque)), 95);
    cout << "The deque now is: ";
    print_deque(deque);

    insert(deque, deque.end, 105);
    cout << "The deque now is: ";
    print_deque(deque);

    insert(deque, prev(end(deque)), 1);
    cout << "The deque now is: ";
    print_deque(deque);

    insert(deque, prev(end(deque)), 2);
    cout << "The deque now is: ";
    print_deque(deque);
